...
class SubscriptionStatusWidget(QWidget):
    ...
    def _update_display(self):
        ...
        try:
            ...
            if user.subscription.tier.value == "spark":
                self.tier_label.setStyleSheet("""
                    QLabel {
                        background-color: #e9ecef;
                        color: #495057;
            ...
            elif user.subscription.tier.value == "growth":
                self.tier_label.setStyleSheet("""
                    QLabel {
                ...
                """)
                self.action_button.setText("Manage Account")
            elif user.subscription.tier.value == "pro_agency":
                self.tier_label.setStyleSheet("""
                    QLabel {
                ...
                """)
                self.action_button.setText("Manage Account")
            elif user.subscription.tier.value == "enterprise":
                self.tier_label.setStyleSheet("""
                    QLabel {
