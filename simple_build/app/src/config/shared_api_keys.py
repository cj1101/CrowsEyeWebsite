...
SHARED_GEMINI_API_KEY = "AIzaSyBH8mGVnzOQKjKjKjKjKjKjKjKjKjKjKjK"  # Replace with your actual API key

# Shared Google API Key for Veo video generation
# Users can override by setting GOOGLE_API_KEY environment variable
SHARED_GOOGLE_API_KEY = "AIzaSyBH8mGVnzOQKjKjKjKjKjKjKjKjKjKjKjK"  # Replace with your actual API key
