...
function SignUpForm() {
  ...
  const { signup, loginWithGoogle, loading: authLoading, isConfigured, isAuthenticated } = useAuth();
    ...
    try {
      ...
      if (result.success) {
        const message = result.isNewUser 
          ? 'Welcome to Crow\'s Eye! Your account has been created successfully with Google.'
          : 'Welcome back! You already have an account with this Google email.';
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 animate-fade-in-delay">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading || authLoading || isGoogleSigningUp || !acceptTerms}
          ...
          <button
            ...
            disabled={isLoading || authLoading || isGoogleSigningUp}
