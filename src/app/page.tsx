        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-6">
            {[
              ...
              { 
                name: 'Snapchat', 
                description: 'Stories, Snaps, Filters', 
                color: 'from-yellow-400 to-yellow-500',
                icon: (
                  <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.166 3.5c-3.818 0-6.916 3.08-6.916 6.878 0 .815.14 1.605.398 2.349-.613.533-1.547 1.37-2.148 1.85-.583.465-.865.971-.865 1.548 0 .905.713 1.628 1.588 1.628.377 0 .736-.127 1.033-.365.513-.41 1.024-.82 1.463-1.15.19.465.424.901.695 1.304.678 1.01 1.653 1.908 2.82 2.436.35.158.616.43.755.776.189.472.154 1.006-.128 1.452-.282.445-.846.813-1.555.944-.25.046-.384.289-.302.537.083.248.339.382.588.336 1.233-.227 2.29-.936 2.87-1.893.58.957 1.637 1.666 2.87 1.893.249.046.505-.088.588-.336.082-.248-.052-.491-.302-.537-.709-.131-1.273-.499-1.555-.944-.282-.446-.317-.98-.128-1.452.139-.346.405-.618.755-.776 1.167-.528 2.142-1.426 2.82-2.436.271-.403.505-.839.695-1.304.439.33.95.74 1.463 1.15.297.238.656.365 1.033.365.875 0 1.588-.723 1.588-1.628 0-.577-.282-1.083-.865-1.548-.601-.48-1.535-1.317-2.148-1.85.258-.744.398-1.534.398-2.349C18.75 6.58 15.652 3.5 11.834 3.5h.332z"/>
                  </svg>
                )
              },
              { 
